...
type VideoServiceClient interface {
	...
	CommentList(ctx context.Context, in *CommentListRequest, opts ...grpc.CallOption) (*CommentListReponse, error)
...
func (c *videoServiceClient) CommentList(ctx context.Context, in *CommentListRequest, opts ...grpc.CallOption) (*CommentListReponse, error) {
	out := new(CommentListReponse)
...
type VideoServiceServer interface {
	...
	CommentList(context.Context, *CommentListRequest) (*CommentListReponse, error)
...
func (UnimplementedVideoServiceServer) CommentList(context.Context, *CommentListRequest) (*CommentListReponse, error) {
